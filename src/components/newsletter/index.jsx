  ...
  return (
    <aside className="b-newsletter" role="complementary">
      <div className="b-boxed b-boxed--light">
        ...
        <form className="b-form" id="newsletter" action="//dbushell.us1.list-manage.com/subscribe/post?u=f1621b8d47b205bc9a898c68f&amp;id=84a4c62ca9" method="post" name="mc-embedded-subscribe-form" target="_blank" noValidate>
          ...
          <div className="b-form__item">
            ...
            <label htmlFor="mce-EMAILTYPE-0" className="e-label e-label--radio">
              <input className="u-vh" type="radio" value="html" name="EMAILTYPE" id="mce-EMAILTYPE-0" defaultChecked/>
              <span>HTML</span>
            </label>
