...
const Archive: React.SFC<any> = props => {
  const nextButton = props.nextPage ? <Button href={props.nextPage} text="Older"/> : null;
  const prevButton = props.prevPage ? <Button href={props.prevPage} text="Newer"/> : null;
